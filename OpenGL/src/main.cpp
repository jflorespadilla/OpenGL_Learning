...
int main(void) {
    ...
    std::cout << glGetString(GL_VERSION) << std::endl;
    {
        ...
        */
        ...
        glm::mat4 model = glm::translate(glm::mat4(1.0f), glm::vec3(0.50f, 0.50f, 0.0f));
        ...
        while (!glfwWindowShouldClose(window)) {
...

            {
                ...
                ImGui::Begin("Dope side window");                          // Create a window called "Hello, world!" and append into it.
